...
module.exports = class TaskController {
    ...
    static async toggleTaskStatus(req, res) {
        ...
        const task = {
            done: req.body.done === '0' ? true : false // se for true eutroco para false, e se for false eu troco para true, é a caixa da de apontar se quer reveber newsletter, uma boolean
        }
